...
def get_parser():
    ...
    parser.add_argument('--loglevel', default='INFO',
                        help='log level (DEBUG/INFO/WARNING/ERROR/CRITICAL), Defaults to INFO')
    ...
    parser.add_argument('--interval', default=1.0, type=float,
                        help='The time interval (s) between two polling, Defaults to 1.0')
    ...
    parser.add_argument('--timeout', default=3.0, type=float,
                        help='Response time-out for MODBUS devices, Defaults to 3.0')
    parser.add_argument('--export', default=None, help='The file name to export references/registers')
    ...
    parser.add_argument('--mqtt-port', default=1883, type=int,
                        help='1833 for non-TLS or 8883 for TLS, Defaults to 1883')
    parser.add_argument('--mqtt-topic-prefix', default='modpoll/',
                        help='Topic prefix to be used for subscribing/publishing. Defaults to "modpoll/"')
    ...
    parser.add_argument('--diagnostics-rate', default=0, type=float,
                        help='Time in seconds after which for each device diagnostics are published via mqtt.')
